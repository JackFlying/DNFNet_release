...
from .search_prw import evaluate_search_prw
from .search_cuhk import evaluate_detections, evaluate_search_nae
...
class EvalHook(Hook):
    ...
    def __init__(self, dataloader, start=None, interval=1, log=None, cfg=None, **eval_kwargs):
    ...
    def after_train_epoch(self, runner):
        ...
        if self.cfg.data_name == 'PRW':
            ...
            from mmdet.apis import single_gpu_test_cuhk
            data_loader, query_data_loader = self.dataloader
            results = single_gpu_test_cuhk(runner.model, data_loader, query_data_loader)
