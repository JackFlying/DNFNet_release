...
class HybridMemory(nn.Module):
    def __init__(self, num_features, num_memory, temp=0.05, momentum=0.2, testing=False):
...
class HybridMemoryMultiFocalPercent(nn.Module):
    def __init__(self, num_features, num_memory, testing, temp=0.05, momentum=0.2, top_percent=0.1):
        ...
        self.idx = torch.zeros(self.num_memory).long()

        self.register_buffer("features", torch.zeros(self.num_memory, num_features))
        self.register_buffer("labels", torch.zeros(self.num_memory).long())
