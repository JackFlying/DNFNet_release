...
from mmdet.models.utils import HybridMemoryMultiFocalPercent, Quaduplet2Loss, HybridMemoryMultiFocalPercentClusterUnlabeled, HybridMemoryMultiFocalPercentClusterUnlabeledGt
from mmcv.ops import DeformConv2dPack

@HEADS.register_module()
class CPCLDICLHead(nn.Module):
    ...
    def __init__(self,
        ...
        super(CPCLDICLHead, self).__init__()
    ...
    def loss(self,
        ...
        # 用混合特征的原因是GT feature也需要得到训练,或者像SSL设置两个memory分别学习
        memory_loss = self.loss_reid(mean_id_pred, id_labels[id_labels != -2], IoU, top_IoU, bottom_IoU)
        memory_loss["global_cluster_hard_loss"] *= self.reid_loss_weight
